...
public interface INodeManagementService
{
    ...
    Task<DHTResponse<bool>> NodeExistsInDHTNetwork(byte[] bicHash);
    ...
    Task<DHTResponse<string>> GetNodeEndpointAsync(byte[] hashedAccount);
    ...
    Task<DHTResponse<NodeInfo>> RemoveNodeFromBucketAsync(NodeInfo nodeInfo);
